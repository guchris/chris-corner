        ...
        <>
            ...
            <div className='page-content'>
                ...
                <section className="job-experience">
                    ...
                    <div className="description">
                        Led the development of a visionary log analytics tool, coupled with a robust triage system for Windows Server bugs, significantly elevating team efficiency and issue resolution.
                        <ul className="small-bullets">
                ...
                <section className="job-experience">
                    ...
                    <div className="description">
                        Elevated the productivity of Azure DevOps users by strategically enhancing Microsoft Flow's capabilities and crafting high-impact templates for widespread adoption, streamlining workflows and automating millions of tasks.<br/>
                        <ul className="small-bullets">
                ...
                <section className="job-experience">
                    ...
                    <div className="description">
                        Pioneered the integration of cutting-edge chatbot technologies at Union Pacific, leveraging NLP and Rasa to prototype innovative internal and consumer-facing chatbots, establishing the company's initial footprint in the realm of conversational AI.<br/>
                        <ul className="small-bullets">
