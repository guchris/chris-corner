            ...
            <div className="page-content">
                ...
                <div className="section">
                    <div className="row-skinny">
                        <img src="sweet-potato-balls-1.png" alt="Image 1" className="image-small"/>
                        <img src="sweet-potato-balls-2.png" alt="Image 2" className="image-small"/>
                    </div>
                </div>

                <h4 className="section-title">The Story</h4>
                <div className="section-gap">
                    <p className="caption-upper">Sunday, December 3, 2023</p>
                    <p className="body-lower">
                ...
                <div className="section">
                    ...
                    <div className="section-skinny">
                        <div className="row-skinny">
                            ...
                            <p className="body-lower">8.5/10</p>
                            <p className="body-lower">9/10</p>
                        </div>
                        <div className="row-skinny">
                            <p className="ranking-category">Appearance</p>
                            <p className="body-lower">4/5</p>
                            <p className="body-lower">4/5</p>
                        </div>
                        <div className="row-skinny">
                            <p className="ranking-category">Effort</p>
                            <p className="body-lower">2/5</p>
                            <p className="body-lower">2/5</p>
                        </div>
                        <div className="row-skinny">
                            <p className="ranking-category">Misc</p>
                            <p className="body-lower">5/5</p>
                            <p className="body-lower">5/5</p>
                        </div>
                        <div className="row-skinny">
                            <p className="ranking-category"><b>Total</b></p>
                            <p className="body-lower"><b>39.5</b></p>
                        </div>
                    </div>
                </div>
            </div>
